...
import edu.gatech.chai.omoponfhir.omopv5.dstu2.mapping.OmopPatient;
...
//	}
	 ...
	 */
	@Read()
	public USCorePatient readPatient(@IdParam IdDt theId) {
		USCorePatient retval = getMyMapper().toFHIR(theId);
		if (retval == null) {
			throw new ResourceNotFoundException(theId);
		}
